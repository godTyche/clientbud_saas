<div class="modal-header">
    <h5 class="modal-title">@lang('app.addNew') @lang('superadmin.menu.testimonial') @lang('app.title')</h5>
    ...
    <div class="portlet-body">
        <x-form id="createMethods" method="POST" class="ajax-form">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <x-forms.text :fieldLabel="__('app.title')" fieldName="testimonial_title" autocomplete="off" fieldId="testimonial_title" fieldRequired="true"/>
                </div>
