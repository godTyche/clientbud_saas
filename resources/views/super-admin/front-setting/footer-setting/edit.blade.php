<div class="modal-header">
    <h5 class="modal-title">@lang('superadmin.footer.editFooterMenu') ( {{$langCode->language_name}} <span class='flag-icon flag-icon-{{ $langCode->flag_code == 'en' ? 'us' : strtolower($langCode->flag_code) }} flag-icon-squared'></span> )</h5>
