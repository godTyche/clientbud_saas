<div class="modal-header">
    <h5 class="modal-title">@lang('app.edit') @lang('superadmin.menu.faq') ( {{$langCode->language_name}} <span class='flag-icon flag-icon-{{ $langCode->flag_code == 'en' ? 'us' : strtolower($langCode->flag_code) }} flag-icon-squared'></span> )</h5>
...
<div class="modal-body">
    <div class="portlet-body">
        <x-form id="updateFAQ" method="PUT" class="ajax-form">
            <div class="form-group">
                <div class="row">
                    <input type="hidden" name="current_language_id" value="{{$lang}}">
                    <div class="col-lg-6">
                        <x-forms.text :fieldLabel="__('superadmin.question')" fieldName="question" autocomplete="off" fieldId="question" :fieldValue="$faq->question" fieldRequired="true" />
                    </div>
                    <div class="col-lg-12">
