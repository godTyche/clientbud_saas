                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <x-forms.text fieldId="title" :fieldLabel="__('app.title')" fieldName="title"
                                              fieldRequired="true" :fieldPlaceholder="__('placeholders.resourceCenter.title')">
                                </x-forms.text>
                                ...
                                <x-forms.label fieldId="selectStaffAssignee" fieldRequired="false"
                                ...
                                <x-forms.label fieldId="selectClientAssignee" fieldRequired="false"
