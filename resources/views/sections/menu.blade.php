    ...
    @if (!in_array('client', user_roles()) && (in_array('employees', user_modules()) || in_array('leaves', user_modules()) || in_array('attendance', user_modules()) || in_array('holidays', user_modules())) && ($sidebarUserPermissions['view_employees'] != 5 || $sidebarUserPermissions['view_leave'] != 5 || $sidebarUserPermissions['view_attendance'] != 5 || $sidebarUserPermissions['view_holiday'] != 5) && ($sidebarUserPermissions['view_employees'] != 'none' || $sidebarUserPermissions['view_leave'] != 'none' || $sidebarUserPermissions['view_attendance'] != 'none' || $sidebarUserPermissions['view_holiday'] != 'none' || $sidebarUserPermissions['view_shift_roster'] != 'none'))
        <x-menu-item icon="people" :text="__('app.menu.hr')">
            ...
            <div class="accordionItemContent pb-2">
                ...
                @endif
                @if (in_array('employees', user_modules()) && isset($sidebarUserPermissions['view_designation']) && $sidebarUserPermissions['view_designation'] == 4 )
                    <x-sub-menu-item :link="route('designations.index')" :text="__('app.menu.designation')" />
                @endif
                @if (in_array('employees', user_modules()) && isset($sidebarUserPermissions['view_department']) && $sidebarUserPermissions['view_department'] == 4)
                    <x-sub-menu-item :link="route('departments.index')" :text="__('app.menu.department')" />
                @endif
                @if (in_array('employees', user_modules()) && isset($sidebarUserPermissions['view_appreciation']) && $sidebarUserPermissions['view_appreciation'] != 5)
                    <x-sub-menu-item :link="route('appreciations.index')" :text="__('app.menu.appreciation')" />
                @endif
                @if (in_array('employees', user_modules()) && isset($sidebarUserPermissions['view_appreciation'])  && $sidebarUserPermissions['view_appreciation'] == 5 && isset($sidebarUserPermissions['manage_award']) && $sidebarUserPermissions['manage_award'] == 4)
...
@if (in_array('emailmarketing', user_modules()) && $sidebarUserPermissions['view_emailmarketing'] != 5 && $sidebarUserPermissions['view_emailmarketing'] != 'none')
        <x-menu-item icon="email" :text="__('Email Marketing')" :link="route('email-marketing.index')">
                    <x-slot name="iconPath">
                        <path 
...
@if (in_array('resourcecenter', user_modules()) && $sidebarUserPermissions['view_resourcecenter'] != 5 && $sidebarUserPermissions['view_resourcecenter'] != 'none')
